...
ggplot(dataset, aes(x = Learning_Style, y = GPA)) +
  geom_boxplot() +
  labs(title = "GPA by Learning Style", x = "Learning Style", y = "GPA")
...
# Create a correlation matrix for Sleep_Hours_PerDay, Screen_Time_PerDay, and GPA
cor_matrix <- cor(dataset[, c("Sleep_Hours_PerDay", "Screen_Time_PerDay", "GPA")], use = "complete.obs")
cor_matrix
